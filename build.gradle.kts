...
dependencies {
	...
	modImplementation("net.glasslauncher.mods:GlassMappingLib:${project.properties["glassmappinglib_version"]}")
...
tasks.withType<ProcessResources> {
	val props = mapOf("version" to project.properties["version"])
